...
import itertools
def get_matrix_f7_10_6_5(selected_num_list=[]):
    matrix_list=[]
    selected_num_list.insert(0,-1)
    s_list =selected_num_list
    if len(s_list)==11:
        list01 = [s_list[1], s_list[4], s_list[5], s_list[6], s_list[7], s_list[8], s_list[9]]
        list02 = [s_list[1], s_list[3], s_list[4], s_list[5], s_list[8], s_list[9],s_list[10]]
        list03 = [s_list[1], s_list[2], s_list[3], s_list[6], s_list[7], s_list[9],s_list[10]]
        list04 = [s_list[2], s_list[3], s_list[4], s_list[5], s_list[6], s_list[9],s_list[10]]
        list05 = [s_list[2], s_list[3], s_list[4], s_list[5], s_list[7], s_list[8],s_list[10]]
...
if __name__ =='__main__':
    ...
    results=get_matrix_f7_10_6_5(selected_num_list)
    print(len(results))
    # for i in results:
    #     x=set(last_one)
    #     y=set(i)
